...
namespace HiddenVilla_Api.Controllers
{
    ...
    public class HotelRoomController : Controller
    {
        ...
        public async Task<IActionResult> GetHotelRoom(int? roomId)
        {
            ...
            var roomDetails = await _hotelRoomRepository.GetById(roomId.Value);
        ...
        //    var roomDetails = await _hotelRoomRepository.GetById(roomId.Value, checkInDate, checkOutDate);
        //    if (roomDetails == null)
        //    {
        //        return BadRequest(new ErrorModel()
        //        {
